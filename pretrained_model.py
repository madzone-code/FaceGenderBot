...
def cnn_from_scratch(train_dataset, validation_dataset, test_dataset):
    ...
    callbacks = [
        ...
        keras.callbacks.ModelCheckpoint(
            ...
            save_best_only=True,
            monitor="val_loss"),
        # Прерываем обучение после 5 эпох без улучшений
...
"""
# Загрузка моделей
features = keras.models.load_model("models/vgg16_features.keras")
features_augmentation = keras.models.load_model("models/vgg16_features_augmentation.keras")
fine_tuning_model = keras.models.load_model("models/fine_tuning_step2.keras")
